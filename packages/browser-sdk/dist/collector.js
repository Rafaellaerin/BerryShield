...
export async function collectSignals(behavior, wasmProbeUrl) {
    const gl = webglInfo();
...
async function runWasmProbe(url) {
    if (!url || typeof WebAssembly !== "object")
        return undefined;
    try {
        ...
        if (typeof mix32 !== "function")
            return undefined;
        const seed = crypto.getRandomValues(new Uint32Array(1))[0];
        return Number(mix32(seed)) >>> 0;
    }
    catch {
        return undefined;
    }
